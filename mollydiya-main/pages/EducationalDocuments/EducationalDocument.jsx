...
import styles from "./EducationalDocument.module.css";
...
export default function EducationalDocument({ onMoreInfo, isFlipped, onFlip, activeCode, onToggleCode, onCopy}) {
  ...
  return (
    <div
      className={`${styles.educational} ${isFlipped ? styles.flipped : ""}`}
      onClick={onFlip} // Обработчик для смены состояния флипа
    >
      <div className={styles["educational-inner"]}>
        {/* Передняя сторона */}
        <div className={styles["educational-front"]}>
          <div className={styles["educational-container"]}>
            <h2 className={styles["educational-title"]}>{user.uEducationName}</h2>
            <h3 className={styles["educational-subtitle"]}>{user.uEducationZaklad}</h3>
            <div className={styles["educational-details"]}>
            <div className={styles["educational-details__right-item"]}>
                <p>Дата видачі:</p>
          ...
          <div className={styles["educational-container"]}>
            <div className={styles["educational-bottom-wrap"]}>
              <div className={styles["educational-bottom-left"]} style={{paddingTop: '0px'}}>
              ...
              <div className={styles["educational-bottom-right"]}>
                <img
                  src={MoreInfoIcon}
                  alt="More info"
                  onClick={(e) => {
                    e.stopPropagation(); // Останавливаем клик для флипа
                    onMoreInfo("educational");
                  }}
        ...
        {/* Задняя сторона */}
        <div className={styles["educational-back"]}>
