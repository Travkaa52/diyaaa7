      ...
      >
        <AnimatePresence mode="wait">
          ...
          >
            {/* FRONT */}
            {!isFlipped && (
              <div className="absolute inset-0 bg-white rounded-3xl shadow-xl border border-gray-200 overflow-hidden">
                <div className="p-5">
            ...
            {/* BACK */}
            {isFlipped && (
              <div className="absolute inset-0 bg-white rounded-3xl shadow-xl border border-gray-200 flex flex-col items-center justify-center">
